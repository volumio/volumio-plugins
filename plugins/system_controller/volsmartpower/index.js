...
Volsmartpower.prototype.SoftSD = function() {
  // this.logger.info('Volsmartpower: shutdown button pressed\n');
  this.commandRouter.reboot();
};
/*
Volsmartpower.prototype.BootOK = function() {
  this.logger.info('Volsmartpower: xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxBootOK\n');
/*var BootOKEnabled = self.config.get('BootOKEnabled');
var BootOKPin = self.config.get('BootOKEnabled');
var BootOK = new Gpio(BootOKPin, 'out');
 BootOK.writeSync(value);

};
*/
Volsmartpower.prototype.ShutDown = function() {
 //  this.logger.info('Volsmartpower: shutdown button pressed wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww\n');
