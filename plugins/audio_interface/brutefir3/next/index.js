...
ControllerBrutefir.prototype.getUIConfig = function() {
 ...
 self.commandRouter.i18nJson(__dirname + '/i18n/strings_' + lang_code + '.json',
  ...
  .then(function(uiconf)
   ...
   //-----Room settings section
    ...
    uiconf.sections[2].content[2].value = self.config.get('subdelay');
   // ------
    ...
    valuestoredls = self.config.get('leftsubfilter');
    self.configManager.setUIConfigParam(uiconf, 'sections[0].content[3].value.value', valuestoredls);
    self.configManager.setUIConfigParam(uiconf, 'sections[0].content[3].value.label', valuestoredls);

    valuestoredrs = self.config.get('rightsubfilter');
    self.configManager.setUIConfigParam(uiconf, 'sections[0].content[4].value.value', valuestoredrs);
    self.configManager.setUIConfigParam(uiconf, 'sections[0].content[4].value.label', valuestoredrs);
 ...
 fs.readdir(filterfolder, function(err, item) {
    ...
    self.configManager.setUIConfigParam(uiconf, 'sections[0].content[8].value.value', valuestoredf);
    self.configManager.setUIConfigParam(uiconf, 'sections[0].content[8].value.label', valuestoredf);
...
//console.log('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA' + routput_device);
  ...
  if (self.config.get('LM3sw') == true) {
    ...
    if ((self.config.get('leftsubfilter') != "None") || (self.config.get('rightsubfilter') != "None")) {
	enablesub = ',"l_sub_out","r_sub_out" ';
...
ControllerBrutefir.prototype.saveBrutefirconfigAccount2 = function(data) {
 ...
 self.config.set('leftsubfilter', data['leftsubfilter'].value);
 self.config.set('rightsubfilter', data['rightsubfilter'].value);
...
ControllerBrutefir.prototype.saveBrutefirconfigroom = function(data) {
 ...
 self.config.set('subdelay', data['subdelay']);
