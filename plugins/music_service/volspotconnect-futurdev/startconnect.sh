...
./librespot -b 320  -c /tmp   --enable-volume-normalization --name 'Volumio-pine64' --backend alsa --device plughw:0 --disable-audio-cache --initial-volume 33  --onstart ./onstart1.sh
