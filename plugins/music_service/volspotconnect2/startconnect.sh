...
./librespot -b 320  -c /tmp   --enable-volume-normalization --normalization-pregain -2 --name 'Volumio-pine64' --backend alsa --device plughw:0 --disable-audio-cache --initial-volume 70  --onstart ./onstart1.sh
