...
./librespot -b 320  -c /tmp  --disable-discovery -u balbuze -p Tvapaqsa0604  --name 'Volumio-pine64' --backend alsa --device plughw:0 --disable-audio-cache --initial-volume 33 # --onstart ./onstart1.sh
