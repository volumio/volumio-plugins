...
//   defer.reject(new Error('brutefir error'));
   self.commandRouter.pushToastMessage('error',"Can't apply Bauer filter");
  })
...
ControllerBrutefir.prototype.setLoopbackoutput= function() {
    var self = this;
    var str = {"output_device":{"value":"0","label":"Loopback"}};
return self.commandRouter.executeOnPlugin('audio_interface', 'alsa_controller', 'saveAlsaOptions', str);
console.log('eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYeeeeee')
};
